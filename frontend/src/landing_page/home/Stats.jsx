        ...
        <div className="container ">
            <div className="row p-5">
                ...
                <div className="col-6 p-5">
                    <img src="media/images/ecosystem.png" className="img-fluid" alt="" />
                    <div className="text-center">
                        <a href="" className="me-4"  style={{textDecoration:"none"}}>Explore our products <i class="fa-solid fa-arrow-right"></i></a>
