  ...
  return (
    <div className="container">
      <div className="row mt-5">
        <h1 className="fs-3 p-4">To create a ticket, select a relevant topic</h1>
        <div className="col-4 support-links p-4">
        ...
        <div className="col-4 support-links p-4">
          <p className="fs-5 mb-5">
            <i class="fa-solid fa-user me-1" style={{ fontSize: "0.9rem" }}></i>{" "}
      ...
      <div className="row mt-4">
        ...
        <div className="col-4 support-links p-4">
          <p className="fs-5 mb-5">
            <i class="fa-solid fa-circle-notch me-1" style={{ fontSize: "0.9rem" }}></i>{" "}
            Console
          </p>
          <p>
            <a href="">Reports</a>
        ...
        <div className="col-4 support-links p-4 mb-3">
          <p className="fs-5 mb-5">
            <i
              class="fa-regular fa-circle me-1"
              style={{ fontSize: "0.9rem" }}
            ></i>{" "}
            Coin
          </p>
